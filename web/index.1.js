...
$(function () {
  ...
  window.onbeforeunload = function(){
    if (Object.keys(questions).length >= 1) return "Are you sure you want to quit ?";
  }
  ...
  socket.on('update_quizz_progress', function(actual_page, total_pages){
    $('#page_txt').text("Page " + actual_page + "/" + total_pages);
  })
